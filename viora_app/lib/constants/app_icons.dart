...
class AppIcons {
  ...
  /// Plant/tree icon
  static const plant = LucideIcons.sprout;
  ...
  static const sprout = LucideIcons.sprout;
  
  /// Tree icon
  static const tree = LucideIcons.trees;
  
  /// Star icon for points/level
  ...
  /// Info circle icon
  static const infoCircle = LucideIcons.info;
  ...
  /// Line chart icon
  static const lineChart = LucideIcons.lineChart;
