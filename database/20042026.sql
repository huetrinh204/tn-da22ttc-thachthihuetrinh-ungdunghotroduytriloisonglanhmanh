...
CREATE TABLE `habits` (
  ...
  `category` enum('eat','sleep','exercise','mental') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-04-20 15:47:29
